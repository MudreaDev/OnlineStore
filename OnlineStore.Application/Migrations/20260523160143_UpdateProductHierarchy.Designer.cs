...
namespace OnlineStore.Application.Migrations
{
    ...
    [Migration("20260523160143_UpdateProductHierarchy")]
    partial class UpdateProductHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("SubscriberEmails")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.ProductImage", b =>
                {
                    ...
                    b.Property<string>("AssociatedColor")
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.SubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ExpectedAttributes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.DynamicProduct", b =>
                {
                    b.HasBaseType("OnlineStore.Domain.Entities.Product");
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.Product", b =>
                {
                    b.HasOne("OnlineStore.Domain.Entities.SubCategory", "SubCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("OnlineStore.Domain.Entities.ProductReview", b =>
                {
                    b.HasOne("OnlineStore.Domain.Entities.ProductReview", null)
                        .WithMany("Replies")
